<template>
    <div id="select-cinema">
      ...
      />
      <div class="content">
        <div class="item" v-for="(item,index) in dateCinemaSchedule" :key="index" @click="$router.push({path:'/cinema_detail',query:{movie_id:$route.query.movieId,cinema_id:item.cinema_id}})">
          <div class="left">
    ...
    export default {
        ...
        methods:{
          async loadInfo(){
            ...
            json = await getCurrentMovieSchedule(this.$route.query.movieId);
